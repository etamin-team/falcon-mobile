...
import 'package:wm_doctor/features/reset_password/presentation/page/set_new_password.dart';
            ...
            if (state is ResetPasswordSuccess) {
              if (state.check) {
                ...
                toastification.show(
                  ...
                  title:
                      Text(LocaleKeys.reset_password_incorrect_password.tr()),
              ...
              child: Container(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        LocaleKeys.reset_password_update_password.tr(),
                        style: TextStyle(
                          fontFamily: "VelaSans",
                      ...
                      AppTextField(
                          validator: (value) {
                            if (value.toString().isEmpty) {
                              return LocaleKeys.reset_password_enter_password
                                  .tr();
                            }
                            return null;
                          },
                          ...
                          title: LocaleKeys
                              .reset_password_enter_previous_password
                              .tr(),
